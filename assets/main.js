...
const ITEMS = [
  ...
  { title: 'Case study — ministry SIEM',      hint: 'section',         kind: '#', href: '#case' },
  ...
  { title: 'View LinkedIn profile',           hint: 'social',          kind: '↗', href: 'https://www.linkedin.com/in/yassir-zahidi/' },
...
(() => {
  ...
  const COMMANDS = {
    ...
    'cv':         () => window.open('https://www.linkedin.com/in/yassir-zahidi/', '_blank', 'noopener'),
    'print':      () => window.print(),
  ...
  const ASK = {
    ...
    'mttr':        'mttr median <5min in the lab — playbooked alerts auto-enrich (misp + virustotal) before human triage. authorized production deployment: 7min p50.',
    ...
    'cv':          'LinkedIn profile — experience, credentials, and current work.',
    'detect':      '14 sigma rules authored, 6213 wazuh rules tuned in the deployment environment, 13 cybersec certs current, mttd<60s on lab.',
